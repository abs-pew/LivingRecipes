...
class RecipeServiceTest {
    ...
    void addRecipe_shouldAddANewRecipe() {
        ...
        RecipeDto inputRecipe = new RecipeDto(ingredientsStr, 45,
                List.of(
                        new Ingredient(ingredientsStr, 1000, UnitsList.GRAM)),
                "put all ingredients together in a pot and cook them well",
                "images link here");

        Recipe recipeToSave = inputRecipe.createNewRecipe(id,
                createdAt, category);
    ...
    void updateRecipeById_shouldReturnUpdatedRecipe_whenCalled() {
        ...
        Recipe recipeToUpdate = new Recipe(id, ingredientsStr, 45,
                List.of(
                        new Ingredient(ingredientsStr, 1000, UnitsList.GRAM)),
                "put all ingredients together in a pot and cook them well",
                "images link here",
        ...
        RecipeDto updatedRecipeDto = new RecipeDto("Chicken65", 145,
                List.of(
                        new Ingredient(ingredientsStr, 11000, UnitsList.GRAM)),
                "put all ingredients together in a pot and cook them well",
